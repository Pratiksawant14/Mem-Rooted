...
export default function ChatInterface({ username, onLogout, onTransparencyUpdate }: Props) {
        ...
        <div className="flex items-center gap-4">
          {username && (
            <div className="flex items-center gap-3 border-r border-border pr-4">
              <div className="px-3 py-1.5 rounded-full bg-surface-elevated border border-border text-xs text-text-secondary">
                <span className="text-primary mr-1">●</span> {username}
              </div>
              <button
                onClick={onLogout}
                className="text-xs text-text-secondary hover:text-white underline-offset-4 hover:underline"
              >
                Sign Out
              </button>
            </div>
          ...
          <Link
            ...
            className="flex items-center gap-2 px-3 py-1.5
                       rounded-lg bg-surface border border-border text-text-secondary text-xs font-medium
